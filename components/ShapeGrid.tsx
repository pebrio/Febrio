...
type ShapeGridProps = {
  direction?: "up" | "right" | "down" | "left" | "diagonal";
  speed?: number;
  borderColor?: string;
  squareSize?: number;
...
export default function ShapeGrid({
  ...
  squareSize = 48,
  hoverFillColor = "rgba(249, 115, 22, 0.18)",
  shape = "square",
  hoverTrailAmount = 4,
  className = "",
}: ShapeGridProps) {
  ...
  return <canvas ref={canvasRef} className={`shapegrid-canvas absolute inset-0 ${className}`} />;
}
